...
export const CollectionModal: React.FC<CollectionModalProps> = props => {
  ...
  const [hasResults, setHasResults] = useState<boolean>(true) // Variable para verificar si hay resultados
    ...
    <>
      <button className="collection_button" type="button" onClick={handleOpen}>
        ...
        <span className="collection_button__icon">
          <svg className="svg-icon" width="24" viewBox="0 0 24 24" height="24" fill="none"><g strokeWidth="2" strokeLinecap="round" stroke="#333333" fillRule="evenodd" clipRule="evenodd"><path d="m3 7h17c.5523 0 1 .44772 1 1v11c0 .5523-.4477 1-1 1h-16c-.55228 0-1-.4477-1-1z"></path><path d="m3 4.5c0-.27614.22386-.5.5-.5h6.29289c.13261 0 .25981.05268.35351.14645l2.8536 2.85355h-10z"></path></g></svg>
        </span>
      </button>
              ...
              <div className="row my-3">
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setHasResults(memeCollection.some(m => m.text.toLowerCase().includes(e.target.value.toLowerCase()))) // Verifica si hay resultados después de cambiar el término de búsqueda
                  }}
                />
              </div>
            </div>
